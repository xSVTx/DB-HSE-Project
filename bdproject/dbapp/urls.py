...
urlpatterns = [
    ...
    path('teacher/<int:id>/delete/', deleteTeacher),
    ...
    path('courses/<int:id>/delete/', deleteCourse),
    ...
    path('exam/<int:id>/delete/', deleteExam),
    ...
    path('lecture/<int:id>/delete/', deleteLecture),
    ...
    path('assignment/<int:id>/delete/', deleteAssignment),
    ...
    path('materials/<int:id>/delete/', deleteMaterials),
